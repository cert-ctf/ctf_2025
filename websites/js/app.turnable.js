...
function handle_down(evt) {
	...
	if (wheelSizes) {
		...
		var layer_clicked = buttonLayer.length - 1;
...
button_right.addEventListener('mousedown', function() { wheelRotateAnim(true); });
button_left.addEventListener('click', function() { wheelRotateAnim(false); });
